...
<!-- badges: start -->
[![R build status](https://github.com/yonicd/ripe/workflows/R-CMD-check/badge.svg)](https://github.com/yonicd/ripe/actions?workflow=R-CMD-check)
...
# ripe `r if(knitr::opts_knit$get('rmarkdown.pandoc.to')=='gfm-ascii_identifiers') '<img src="https://github.com/yonicd/ripe/raw/master/input/logo.png" align="right" />'`
